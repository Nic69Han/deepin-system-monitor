...
protected:
    ...
    int insideRingRadius = 30;
    int lineHeight = 14;
    int memoryPercentRenderSize = 11;
    int memoryRenderPaddingX = 13;
    int memoryRenderPaddingY = 30;
    int memoryRenderSize = 8;
    int outsideRingRadius = 35;
    int pointerRadius = 2;
    int pointerRenderPaddingX = 4;
    int pointerRenderPaddingY = 6;
    int ringCenterPointerX;
    int ringCenterPointerY = 40;
    int ringWidth = 5;
    int swapRenderPaddingX = 13;
    int swapRenderPaddingY = 55;
